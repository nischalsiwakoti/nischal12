# SOURCE BY : Nischal
#JOIN MY WHATSAPP :https://chat.whatsapp.com/DN5gBJnafyZAceDOQWrx4E
from os import path
...
def p(x):
	print(x)
os.system(f'https://chat.whatsapp.com/DN5gBJnafyZAceDOQWrx4E')
...
---------------------------------------------------
\033[1;37m \033[1;37mOwner     :   Nischal xwd
 Github    :   Nischalxwd5
 status      :   FREE
 What's up :   9762900020
 Version   :  11
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
